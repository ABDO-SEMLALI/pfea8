 <?php
                    session_start();
                        ...
                        $sql = "SELECT id_etu,nom_complet,nom_filliere FROM etudiant WHERE id_groupe = 0 AND nom_filliere = '".$fill."'";
...
-->
 ...
 <?php
                      ...
                      if ($result->num_rows > 0) {
                              ...
                              echo "<fieldset>
  <legend> Sélectionner les etudiants</legend>
  <br>";
                            ...
                            while($row = $result->fetch_assoc()) 
                            {
                                ...
                                echo " 
                                <div>
                                <input type='checkbox'  id='" . $row["id_etu"]. "' name='checkbox[]' value=".$row["id_etu"].">&nbsp&nbsp&nbsp&nbsp
                                    <label for='" .$row["id_etu"]. "'>".$row["nom_complet"]."</label> </div>";
        ...
        <input type='submit' name='add' id='add' value='Créer le groupe'>";
                            ...
                            { 
                                echo "<fieldset><h1>Tous les etudiants ont des groupes</h1></fieldset>"; 
                            }
                        $conn->close();
                    ?>
